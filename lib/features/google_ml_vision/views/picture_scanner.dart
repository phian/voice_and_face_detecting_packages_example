...
class _PictureScannerState extends State<PictureScanner> {
  ...
  CustomPaint _buildResults(Size imageSize, dynamic results) {
    ...
    switch (_currentDetector) {
      case Detector.barcode:
        painter = BarcodeDetectorPainter(_imageSize ?? Size(0, 0), results);
        break;
      case Detector.face:
        painter = FaceDetectorPainter(_imageSize ?? Size(0, 0), results);
        break;
      case Detector.label:
        painter = LabelDetectorPainter(_imageSize ?? Size(0, 0), results);
        break;
      case Detector.text:
        painter = TextDetectorPainter(_imageSize ?? Size(0, 0), results);
        break;
      default:
        break;
    }
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: Image.file(_imageFile ?? File("")).image,
          fit: BoxFit.fitWidth,
        ),
      ),
